            ...
            if (!File.Exists(dbPath))
            {
                ...
                using (var conn = GetConnection())
                {
                    string sql = @"
                        ...
                        INSERT INTO Competitions (Name, SportId, Date) VALUES 
                        ('Чемпионат России по бегу 100м', 1, '15.03.2024'),
                        ('Кубок России по бегу 200м', 2, '22.04.2024'),
                        ('Международный турнир по тяжёлой атлетике', 3, '10.05.2024'),
                        ('Первенство города по прыжкам в длину', 4, '05.06.2024'),
                        ('Спартакиада по бегу 100м', 1, '20.07.2024'),
                        ('Открытый чемпионат по плаванию 50м', 6, '15.08.2024'),
                        ('Чемпионат области по прыжкам в высоту', 5, '01.09.2024'),
                        ('Кубок федерации по гимнастике', 7, '10.10.2024');
